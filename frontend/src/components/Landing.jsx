...
About</p></li>
            <li><p onClick={() => contact.current.scrollIntoView({ behavior: 'smooth' })}> Contact</p></li>
      ...
      <section id="about" ref={about} className="about-section">
        ...
        <div className="about-content reverse">
          ...
          <div className="about-text">
            <p><strong>What Web App Provides</strong></p>
  ...
  <div className="social-icons">
    <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="social-icon">
      ...
      <footer className="footer">
        <p>&copy; 2026 Ease2Work. All rights reserved.</p>
      </footer>
    </div>
  )
}